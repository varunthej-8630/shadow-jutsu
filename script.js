...
function resetClones() {
  ...
  console.log("Jutsu Reset! Ready to clone again.");
}
...
holistic.onResults((res) => {
  ...
  // Varunthej watermark on canvas
  ctx.save();
  ctx.font = "bold 13px 'Rajdhani', sans-serif";
  ctx.fillStyle = "rgba(255, 140, 0, 0.55)";
  ctx.textAlign = "right";
  ctx.fillText("VARUNTHEJ", canvas.width - 10, canvas.height - 10);
  ctx.restore();
});
